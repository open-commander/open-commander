...
/**
 * Confirmation modal for removing a session that has dependent children.
 */
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-white/10 bg-(--oc-panel-strong) p-6 shadow-xl">
        ...
        <p className="mt-2 text-sm text-slate-300">
          <span className="font-semibold text-white">{sessionName}</span> has{" "}
          {childCount} dependent {childCount === 1 ? "session" : "sessions"}{" "}
